...
public class ShowController {
	...
	@GetMapping("/search/screen/{screenId}")
	@ResponseStatus(HttpStatus.OK)
	public List<ShowDto> getShowByScreen(@PathVariable Long screenId){
		return showservice.getShowByScreen(screenId);
	}
	
	@PatchMapping("/update/{showId}")
	@ResponseStatus(HttpStatus.OK)
	public ShowDto updateShow(@RequestBody List<ShowUpdateDto> showUpdateDto,@PathVariable Long showId ) {
		return showservice.updateShow(showUpdateDto, showId);
	}
